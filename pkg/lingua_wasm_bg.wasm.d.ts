...
export function detect(a: number, b: number, c: number): void;
export function __wbg_languagedetectorbuilder_free(a: number, b: number): void;
export function __wbg_languagedetector_free(a: number, b: number): void;
